(() => {
    ...
    function an() {
        ee = ee.concat(et.takeRecords()), ee.length && !nt && (nt = !0, queueMicrotask(() => {
            ln(), nt = !1
        }))
    }
...
`:""}`, t), setTimeout(() => {
    ...
    function sr() {
        document.body || O("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), B(document, "alpine:init"), B(document, "alpine:initializing"), rt(), jt(t => w(t, R)), _e(t => gn(t)), Kt((t, r) => {
            re(t, r).forEach(n => n())
        });
    ...
    function pr(e, t) {
        t._x_dataStack || (t._x_dataStack = e._x_dataStack), _t = !0, On(() => {
            An(t)
        }), _t = !1
    }
    ...
    function Tn(e, t) {
        ...
        else if (e.type === "checkbox") Number.isInteger(t) ? e.value = t : !Number.isInteger(t) && !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => mr(r, e.value)) : e.checked = !!t;
    ...
    function L(e, t, r, n, i, o) {
        ...
        else if (r === "length" && $(e)) s.forEach((u, p) => {
            (p === "length" || p >= n) && c(u)
        });
    ...
    function de(e, t, r, n) {
        let i = e,
            ...
            s = {},
            a = (c, l) => u => l(c, u);
        if (r.includes("dot") && (t = di(t)), r.includes("camel") && (t = pi(t)), r.includes("passive") && (s.passive = !0), r.includes("capture") && (s.capture = !0), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("prevent") && (o = a(o, (c, l) => {
